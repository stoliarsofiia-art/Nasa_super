"""
Vercel Serverless Function for Exoplanet Classification API
"""
...
def get_system():
    """Lazy load the classification system"""
    global _system
    if _system is None:
        print("Loading exoplanet classification model...")
        _system = ExoplanetClassificationSystem()
        _system.load_models()
...
def home():
    ...
    return jsonify({
        ...
        'endpoints': {
            ...
            '/api/analyze': 'POST - Analyze exoplanet data'
        }
    })
